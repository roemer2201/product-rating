...
- [ ] **[M]** Auf einem echten iPhone prüfen: Installation, Scanner, Kamera-Upload, Sitzung überlebt Neustart, Safe-Area-Layout, dazu die Offline-Warteschlange samt Foto (dass ein `Blob` die IndexedDB übersteht, ist eine Zusage des Browsers – der Test-Ersatz gibt ihn als einfaches Objekt zurück und kann es deshalb nicht belegen). Stand 2026-08-24: Hinzufügen zum Home-Bildschirm, Scanner und Kamera-Upload bestätigt; die Warteschlange verlor eine Erfassung, wenn iOS die App im Hintergrund beendete – Ursache und Behebung siehe HISTORY. Offen bleiben der Nachtest dieser Behebung, das Safe-Area-Layout und die Erfassung mit Foto
- [ ] **[S]** Nachtest der Warteschlange auf dem iPhone: offline erfassen, App aus dem App-Umschalter wischen, App neu starten – die Erfassung muss noch da sein und online übertragen werden
